        ...
        <div class="col-xs-12 table-responsive">
            ...
            <tbody>
                <?php
                    ...
                    $total=0;
                    $nomor_pesanan=addslashes(trim($_GET['nomor_pesanan']));
                    $result=mysqli_query($kon,"select p.nama as nama_produk, p.*, d.*, n.* from pesanan_detail d inner join produk p on p.id=d.kode_produk left join pesanan n on n.nomor_pesanan=d.nomor_pesanan where n.nomor_pesanan='$nomor_pesanan' ");
