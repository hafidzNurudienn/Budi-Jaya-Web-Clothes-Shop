...
<div class="women-product">
    ...
    if (isset($_GET['aut'])) {
        ...
        if (isset($_GET['aut'])) {
            if ($_GET['aut']=='password_reset'){
                echo"<div class='alert alert-warning'>Password Berhasil Direset. Silahkan Login!</div>";
            } 
        }
    ?>
    <form method="post" action="pages/login.php">
        ...
        <p>Belum punya akun? <a href="index.php?page=daftar" >Daftar sekarang</a> atau Lupa Password? <a href="index.php?page=reset" >Ubah disini</a></p> 
