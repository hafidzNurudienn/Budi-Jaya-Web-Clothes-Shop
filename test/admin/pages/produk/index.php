                        ...
                        <table class="table table-bordered table-striped" id="tabel_produk" width="100%" cellspacing="0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <button class="tombol_edit btn btn-warning btn-circle" id_produk="<?php echo $data['id']; ?>"  kode_produk="<?php echo $data['id']; ?>"><i class="fa fa-edit"></i></button>
                                        <a href="pages/produk/hapus.php?id_produk=<?php echo $data['id']; ?>" class="tombol_hapus btn btn-danger btn-circle" ><i class="fa fa-trash"></i></a>
                                    </td>
                                </tr>
