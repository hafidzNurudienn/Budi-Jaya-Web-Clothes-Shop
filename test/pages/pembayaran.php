...
<p>Halo <strong><?php echo $nama_pelanggan; ?></strong></p>
<p>Terima kasih atas pesanan Anda. Status masih tertahan sampai kami mengonfirmasi bahwa pembayaran telah diterima.</p>
<p>Sementara itu, berikut adalah pengingat untuk pesanan Anda:</p>
...
<table class="table table-striped table-bordered">
    ...
    <tbody>
        <?php
            ...
            $sql="select * from pesanan p inner join pesanan_detail d on p.nomor_pesanan=d.nomor_pesanan inner join produk k on k.id=d.kode_produk where p.nomor_pesanan='$nomor_pesanan'";
    ...
    <?php 
        endwhile;
    ?>
    <tr><td colspan="5">Potongan</td><td>Rp. <?php echo number_format($potongan,0,',','.');?> </td>
    </tr>
    <tr><td colspan="5">Ongkos Kirim</td><td>Rp. <?php echo number_format($tarif,0,',','.');?> </td>
    </tr>
    <tr><th colspan="5">Total Bayar</th><th>Rp. <?php echo number_format((($total+$tarif)-$potongan),0,',','.'); ?> </th>
    </tr>
    </tbody>
</table>
</div>
