                        ...
                        <table class="table table-bordered table-striped" id="tabel_produk" width="100%" cellspacing="0">
                            ...
                            <tbody>
                                <?php
                                    ...
                                    $sql="select * from produk p LEFT join ukuran u on p.id = u.produk_id WHERE u.produk_id != 0";
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <button class="tombol_edit btn btn-warning btn-circle" id_produk="<?php echo $data['produk_id']; ?>"  id_detail="<?php echo $data['id']; ?>"><i class="fa fa-edit"></i></button>
                                        <a href="pages/produk/hapus_detail.php?id_produk=<?php echo $data['id']; ?>" class="tombol_hapus btn btn-danger btn-circle" ><i class="fa fa-trash"></i></a>
                                    </td>
                                </tr>
...
<script>
    ...
    $('#tambah').on('click',function(){
        $.ajax({
            url: 'pages/produk/tambah_detail.php',
            method: 'post',
...
<script>
    ...
    $('.tombol_edit').on('click',function(){
        ...
        $.ajax({
            url: 'pages/produk/edit_detail.php',
            method: 'post',
